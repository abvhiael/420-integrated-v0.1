...
contract BTCLightClientAdapter is IBridgeAdapter420 {
    function adapterId() external pure returns(bytes32){return keccak256(bytes("420/BRIDGE/BTCLightClientAdapter"));}
