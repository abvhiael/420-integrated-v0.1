...
contract ExchangeEmergencyControl420 is SystemAccess {
    enum Domain { NONE, SWAPS, LIMIT_ORDERS, BRIDGE_DEPOSITS, BRIDGE_WITHDRAWALS, MARKET_ACTIVATION, FEE_ROUTING }
    ...
    function requireOpen(Domain domain) external view { require(!halted[domain], "exchange halted"); }
}
