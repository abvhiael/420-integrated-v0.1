...
library ActionIds {
    ...
    bytes32 internal constant SESSION_POLICY_SET_ROUTINE_CALL = keccak256("HC.ACTION.GAMING_SESSION_POLICY.SET_ROUTINE_CALL");
    bytes32 internal constant GUEST_MIGRATION_APPLY = keccak256("HC.ACTION.GUEST_MIGRATION.APPLY");
    bytes32 internal constant OPTIONAL_COMPETITION_REGISTER = keccak256("HC.ACTION.COMPETITION_ENGINE.OPTIONAL_COMPETITION_REGISTER");
    bytes32 internal constant OPTIONAL_COMPETITION_SET_STATUS = keccak256("HC.ACTION.COMPETITION_ENGINE.OPTIONAL_COMPETITION_SET_STATUS");
