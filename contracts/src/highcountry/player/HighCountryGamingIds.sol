...
library HighCountryGamingIds {
    ...
    bytes32 internal constant ENTITLEMENT_SPECIAL_FACILITY = keccak256("420/HC/ENTITLEMENT/SPECIAL_FACILITY/V1");
    bytes32 internal constant ENTITLEMENT_SEASONAL_EVENT = keccak256("420/HC/ENTITLEMENT/SEASONAL_EVENT/V1");
    bytes32 internal constant ENTITLEMENT_PRESTIGE_AREA = keccak256("420/HC/ENTITLEMENT/PRESTIGE_AREA/V1");
}
