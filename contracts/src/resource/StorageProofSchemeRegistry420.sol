...
contract StorageProofSchemeRegistry420 is I420System {
    ...
    function _get(bytes32 proofSchemeId) private view returns (Scheme storage scheme) {
        scheme = _schemes[proofSchemeId];
        if (!scheme.exists) revert SchemeNotFound();
    }
}
