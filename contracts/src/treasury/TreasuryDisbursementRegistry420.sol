...
contract TreasuryDisbursementRegistry420 is I420System, SystemAccess {
    ...
    error InvalidDisbursement(); error DisbursementExists(); error DisbursementNotFound(); error Unauthorized(); error InvalidState(); error NotExecutable(); error EpochLimit();
