...
contract VPNPolicyRegistry420 is SystemAccess, I420System {
    struct Policy {
        bytes32 policyType;
    ...
    function systemName() external pure returns (string memory) { return "VPNPolicyRegistry420"; }
    ...
    function _validPolicyType(bytes32 x) private pure returns (bool) {
        return x == VPNIds420.POLICY_ROUTE || x == VPNIds420.POLICY_PRICING || x == VPNIds420.POLICY_EXIT_USAGE || x == VPNIds420.POLICY_SLA;
    }
}
