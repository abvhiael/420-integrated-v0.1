...
contract BetCasinoConvergence420Test {
    ...
    function testGameVersionBindingsAreDomainSeparatedAcrossCasinoModules() public pure {
        bytes32[6] memory versions = [DICE_V1, KENO_V1, PLINKO_V1, SLOT_V1, ROULETTE_V1, BLACKJACK_V1];
        bytes32[6] memory rulesets = [DICE_RULESET, KENO_RULESET, PLINKO_RULESET, SLOT_RULESET, ROULETTE_RULESET, BLACKJACK_RULESET];
