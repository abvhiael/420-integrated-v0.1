...
420Docs is the canonical documentation portal for the 420 Integrated ecosystem.
...
420Docs is designed to be:

- task-oriented for users;
- precise and implementation-aware for developers and operators;
- explicit about permissions, value movement, trust boundaries, and failure recovery;
- version-aware;
