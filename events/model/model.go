...
const (ServiceID="420/service/events/v1";APIVersion="v1")

type Status string
const (StatusDraft Status="DRAFT";StatusScheduled Status="SCHEDULED";StatusLive Status="LIVE";StatusEnded Status="ENDED";StatusCancelled Status="CANCELLED")

type TransitionRecord struct {From Status;To Status;Reason string;OccurredAt time.Time}
...
func ValidStatus(v Status)bool{
 switch v {case StatusDraft,StatusScheduled,StatusLive,StatusEnded,StatusCancelled:return true;default:return false}
}
func ValidVisibility(v Visibility)bool{
 switch v {case VisibilityPublic,VisibilityUnlisted,VisibilityFollowers,VisibilityCommunityOnly,VisibilityPrivate,VisibilityOrganizationMembers:return true;default:return false}
}
...
func (e Event) Validate()error{
 ...
 if e.Recurrence!=nil{
  if err:=e.Recurrence.Validate();err!=nil{return err}
  if !e.Recurrence.Until.IsZero()&&e.Recurrence.Until.Before(e.StartAt){return errors.New("recurrence until precedes event start")}
 }
 return nil
}
...
func CloneEvent(in Event)Event{
 ...
 out.Recurrence=CloneRecurrence(in.Recurrence)
 return out
}
...
func GenesisBoundary()ServiceBoundary{
 return ServiceBoundary{RegistryAuthority:false,IdentityAuthority:false,PaymentAuthority:false,BookingAuthority:false,CalendarAuthority:false,EventLifecycleAuthority:true,DiscoveryCanonical:false}
}
