...
export async function fetchExecutableSwapReview({runtime,request,nowSeconds,fetchImpl=globalThis.fetch,signal}={}){
  ...
  // Validate the request and deployment locally before making any network call.
  ...
  return validateExecutableSwapQuote({runtime,request,response:body,nowSeconds});
}
