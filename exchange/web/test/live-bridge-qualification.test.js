...
const common=()=>({sourceProvider:provider('0x420',addr(1),addr(20)),destinationProvider:provider('0x421',addr(2),addr(30)),sourceRuntime,destinationRuntime:destRuntime,reviewedIntent,execution,sourceAuthorizationChecks:checks,destinationAdapterId:id(8),proofProvider,maxAttempts:1,pollMs:0});
