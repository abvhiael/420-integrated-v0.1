...
func HandlerWithReader(reader PublicReader) http.Handler {
 ...
 mux.HandleFunc("GET /travel", func(w http.ResponseWriter, r *http.Request) {
  data := pageData{Route: "discover", Heading: "Explore somewhere new.", State: "disconnected", Message: "Discovery is not connected yet", Destination:strings.TrimSpace(r.URL.Query().Get("destination"))}
