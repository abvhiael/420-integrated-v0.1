...
STAGES: tuple[Stage, ...] = (
    ...
    Stage("generated-reference-version", (sys.executable, "scripts/validate-doc-generated-reference-version.py")),
    Stage("migration-policy", (sys.executable, "scripts/validate-doc-migration-policy.py")),
    Stage("contextual-registry", (sys.executable, "scripts/validate-doc-contextual-registry.py")),
    Stage("contextual-dapp-materialization", (sys.executable, "scripts/validate-doc-contextual-dapp-map.py")),
    Stage("contextual-version-coupling", (sys.executable, "scripts/validate-doc-contextual-version-coupling.py")),
    Stage("contextual-publication-safety", (sys.executable, "scripts/validate-doc-contextual-publication.py")),
    Stage("assistant-source-registry", (sys.executable, "scripts/validate-doc-assistant-source-registry.py")),
    Stage("assistant-intents", (sys.executable, "scripts/validate-doc-assistant-intents.py")),
    Stage("assistant-citations", (sys.executable, "scripts/validate-doc-assistant-citations.py")),
    Stage("assistant-network-version", (sys.executable, "scripts/validate-doc-assistant-network-version.py")),
    Stage("assistant-troubleshooting", (sys.executable, "scripts/validate-doc-assistant-troubleshooting.py")),
    Stage("assistant-privacy", (sys.executable, "scripts/validate-doc-assistant-privacy.py")),
    ...
    Stage("pages-publication-contract", (sys.executable, "scripts/validate-doc-pages-publication.py")),
    Stage("canonical-publication-contract", (sys.executable, "scripts/validate-doc-canonical-publication.py")),
    Stage("repository-integration-contract", (sys.executable, "scripts/validate-doc-repository-integration.py")),
    Stage("wallet-integration-contract", (sys.executable, "scripts/validate-doc-wallet-integration.py")),
    ...
    Stage("canonical-metadata-render", (sys.executable, "scripts/inject-doc-canonical-links.py", "--site-dir", "site")),
    Stage("canonical-render-validation", (sys.executable, "scripts/validate-doc-canonical-render.py", "--site-dir", "site")),
