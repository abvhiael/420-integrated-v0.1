...
if len(decision.get("apps",[]))!=15: errors.append("expected 15 entries including testnet faucet")
...
out={"pass":not errors,"errors":errors,"genesis_apps":14,"testnet_only_apps":1,"explorer_profile":"420-explorer-genesis-v1","search_profile":"420-search-genesis-v1","arbitration_profile":"420-arbitration-genesis-v1"}
