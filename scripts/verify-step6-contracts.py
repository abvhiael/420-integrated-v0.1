...
if len(assign)!=20: errors.append(f"expected 20 assignments, got {len(assign)}")
...
if addresses[0]!="0x0000000000000000000000000000000000000420": errors.append("range start wrong")
if addresses[-1]!="0x0000000000000000000000000000000000000433": errors.append("range end wrong")
...
# ensure application domains are not merged into consensus domains
...
# monetary constants from contracts
