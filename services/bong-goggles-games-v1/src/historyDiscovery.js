...
function buildRewardsHook({ player, gameType, stats }) {
  return Object.freeze({
    ...
    deferredReason: 'CANONICAL_GAME_CONTRIBUTION_VERIFIER_NOT_IMPLEMENTED',
    canonicalSessionSource: 'BongGogglesGameSessionRegistry420',
    canonicalGameContributionVerifierRequired: true,
    supportedRewardContributionTypes: Object.freeze([]),
    statsRewardAuthority: false,
    leaderboardRewardAuthority: false,
    streakRewardAuthority: false,
    localGameResultRewardAuthority: false,
    zeroWagerRequiredIfEnabledLater: true,
    finishedSessionRequiredIfEnabledLater: true,
    canonicalParticipantBeneficiaryRequiredIfEnabledLater: true,
    deterministicSessionSourceKeyRequiredIfEnabledLater: true,
    antiFarmingPolicyRequiredIfEnabledLater: true,
    duplicateSessionRewardPreventionRequiredIfEnabledLater: true,
    awardRequested: false,
    mintRequested: false,
    contributionRequested: false,
    authoritative: false
  });
}
