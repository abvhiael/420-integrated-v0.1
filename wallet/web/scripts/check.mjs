...
requireStrings('core/genesis-app-catalog.js', ['420/service/protocol-registry/v1','420/service/pay/v1','420/service/compute-market/v1','420/service/analytics/v1','420/service/verify/v1','420/service/notifications/v1','NO_CANONICAL_SERVICE_ID'], 'W14.5 Genesis app catalogue guard');
